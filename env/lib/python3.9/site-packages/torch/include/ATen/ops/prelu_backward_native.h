...
namespace at {
namespace native {
TORCH_API ::std::tuple<at::Tensor &,at::Tensor &> prelu_backward_out(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & weight, at::Tensor & out0, at::Tensor & out1);
